            ...
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="p-6 lg:p-8">
                <div className="grid grid-cols-2 gap-3 h-full min-h-[300px]">
                  <div className="bg-pink-400 rounded-3xl row-span-2 relative shadow-md hover-lift transition-smooth animate-fade-in-up">
                    <div className="absolute top-4 right-4 bg-white rounded-lg px-3 py-1.5 shadow-lg text-xs font-bold flex items-center gap-1 animate-fade-in-down" style={{animationDelay: "0.4s"}}><span className="text-green-500">✓</span> Payment</div>
                  </div>
                  <div className="bg-amber-400 rounded-3xl shadow-md hover-lift transition-smooth animate-fade-in-up" style={{animationDelay: "0.1s"}}></div>
                  <div className="bg-neon-blue rounded-3xl shadow-md hover-lift transition-smooth animate-fade-in-up" style={{animationDelay: "0.2s"}}></div>
                </div>
              </div>
            </div>
          </div>
