        ...
        <div className="min-h-screen bg-[#F8FAFC]">
            ...
            <div className="max-w-[1440px] mx-auto px-8 py-12">
                ...
                <Tabs.Root defaultValue="kpi" className="w-full">
                    <Tabs.List className="flex border-b border-[#E2E8F0] mb-8">
                        <Tabs.Trigger
                            value="kpi"
                            className="flex-1 px-6 py-3 text-sm font-medium text-slate-600 border-b-2 border-transparent hover:text-slate-900 data-[state=active]:text-[#2563EB] data-[state=active]:border-[#2563EB] transition-colors"
                        >
                    ...
                    {/* Tab Content: Section 1 - Top KPI */}
                    <Tabs.Content value="kpi">
                        <section>
                            <div className="flex items-center gap-3 mb-6">
                                <TrendingUp className="w-6 h-6 text-slate-600" />
                                <h2 className="text-2xl font-semibold text-slate-900">Top KPI</h2>
                            </div>
                            ...
                            <div className="grid grid-cols-5 gap-4">
                                ...
                                />
                                <KPICard
                                    title="Followers Retention Rate"
                                    value="92.4%"
                                    trend="up"
                                    trendValue="+1.8%"
                                    sparklineData={generateSparklineData()}
                    ...
                    {/* Tab Content: Section 2 - Cost & Growth Metrics */}
                    <Tabs.Content value="growth">
                        <section>
                            <div className="flex items-center gap-3 mb-6">
                                <TrendingUp className="w-6 h-6 text-slate-600" />
                                <h2 className="text-2xl font-semibold text-slate-900">Cost & Growth Metrics</h2>
                            </div>
                    ...
                    {/* Tab Content: Section 3 - Reach & Visibility */}
                    <Tabs.Content value="reach">
                        <section>
                            <div className="flex items-center gap-3 mb-6">
                                <Eye className="w-6 h-6 text-slate-600" />
                                <h2 className="text-2xl font-semibold text-slate-900">Reach & Visibility</h2>
                            </div>
                            ...
                            <div className="grid grid-cols-5 gap-4">
                                ...
                                <MetricTile
                                    label="Discovery %"
                                    value="34.5%"
                                    sublabel="Non-followers"
                                />
                            </div>
                        </section>
                    </Tabs.Content>

                    {/* Tab Content: Section 4 - Engagement Performance */}
                    <Tabs.Content value="engagement">
                        <section>
                            <div className="flex items-center gap-3 mb-6">
                                <ThumbsUp className="w-6 h-6 text-slate-600" />
                                <h2 className="text-2xl font-semibold text-slate-900">Engagement Performance</h2>
                            </div>
