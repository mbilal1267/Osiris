        ...
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
          ...
          <div className="px-8 pb-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8">
              ...
              <div className="bg-gray-50 rounded-xl p-4 text-center"><p className="text-2xl font-bold text-[#10B981]">98%</p><p className="text-xs text-gray-500">Reliability Score</p></div>
            ...
            <div className="mt-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                {creator.niches.map((n, i) => (
                  <div key={n} className={`flex items-center gap-2 rounded-xl px-4 py-3 ${i === 0 ? 'bg-brand/10 text-brand' : 'bg-gray-50 text-gray-700 border border-gray-100'}`}>
            ...
            {pastBrands.length > 0 && (
              <div className="mt-8">
                ...
                <div className="space-y-3">{pastBrands.map((brand, i) => (
